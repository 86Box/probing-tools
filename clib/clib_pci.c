...
static const char         win_notice[] = "NOTICE:         These are dummy configuration registers generated by libpci, as it cannot access the real ones under Windows. They do not reflect the device's actual configuration.";
#    endif
#endif
